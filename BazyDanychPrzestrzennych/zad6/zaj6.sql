raster2pgsql.exe -s 3763 -N -32767 -t 100x100 -I -C -M -d "C:\semestr_V\Bazy_danych_przestrzennych\zad6\rasters\srtm_1arc_v3.tif" rasters.dem | psql -d zaj6 -h localhost -U postgres -p 5432


raster2pgsql.exe -s 3763 -N -32767 -t 128x128 -I -C -M -d "C:\semestr_V\Bazy_danych_przestrzennych\zad6\rasters\Landsat8_L1TP_RGBN.tif" rasters.landsat8 | psql -d zaj6 -h localhost -U postgres -p 5432
